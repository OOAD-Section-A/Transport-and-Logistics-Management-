...
public class WMSIntegration {
    ...
    public void pollAndProcess() {
        ...
        for (ShipmentReadyEvent event : ready) {
            ...
            System.out.println("      Orders:   " + event.getOrderIds());
            System.out.println("      Weight:   " + event.getTotalWeightKg() + "kg");
            System.out.println("      Packages: " + event.getTotalPackages());
            System.out.println("      Barcode:  " + event.getBarcode());
            System.out.println("      Contents: " + event.getContents());
